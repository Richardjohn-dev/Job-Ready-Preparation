...
- #1 Career readiness system roadmap: https://github.com/Richardjohn-dev/Job-Ready-Preparation/issues/1

## Consolidated Issues

| GitHub issue | Title | Local CRI coverage | Status |
| --- | --- | --- | --- |
...
- The original local CRI backlog remains in `career-readiness-local-issues.md`.
- GitHub issues are intentionally consolidated so worker prompts can be shorter.
- Orchestrator review still controls completion decisions.
